...
def analyze(file_name, lis_struct, time, args):
    ...
    #    if k_val > lis_struct[time]["K"]["ref_high"]:
    #        event_time = time
    ...
    #        event_str = "Hyperkalemia (current value {}; reference value {})".format(k_val, lis_struct[time]["K"]["ref_high"])
    ...
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "Hyperkalemia (current value {}; reference value {})".format(k_val, __k_ul)
    #        __event_dict[file_name][event_time].append(event_str)
    #if "ref_low" in lis_struct[time]["K"].keys():
    #    if k_val < lis_struct[time]["K"]["ref_low"]:
    #        event_time = time
    #        if file_name not in __event_dict.keys():
    #            __event_dict[file_name] = {}
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "Hypokalemia (current value {}; reference value {})".format(k_val, lis_struct[time]["K"]["ref_low"])
    #        __event_dict[file_name][event_time].append(event_str)
    #else:
    #    if args.warn:
    ...
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "Hypokalemia (current value {}; reference value {})".format(k_val, __k_ll)
    #        __event_dict[file_name][event_time].append(event_str)
    ...
    if k_val > 6:
        ...
        if event_time not in __event_dict[file_name].keys():
            __event_dict[file_name][event_time] = []
        event_str = "Severe hyperkalemia ({} ({}))".format(k_val, lis_struct[time]["K"]["unit"])
        __event_dict[file_name][event_time].append(event_str)
    if k_val < 3:
        event_time = time
        if file_name not in __event_dict.keys():
        ...
        if event_time not in __event_dict[file_name].keys():
            __event_dict[file_name][event_time] = []
        event_str = "Severe hypokalemia ({} ({}))".format(k_val, lis_struct[time]["K"]["unit"])
        __event_dict[file_name][event_time].append(event_str)
    return False
