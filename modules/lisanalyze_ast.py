...
def analyze(file_name, lis_struct, time, args):
    ...
    #    if ast_val > lis_struct[time]["AST"]["ref_high"]:
    #        event_time = time
    ...
    #        event_str = "AST too high (current value {}; reference value {})".format(ast_val, lis_struct[time]["AST"]["ref_high"])
    ...
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "AST too high (current value {}; reference value {})".format(ast_val, __ast_ul)
    #        __event_dict[file_name][event_time].append(event_str)
    #if "ref_low" in lis_struct[time]["AST"].keys():
    #    if ast_val < lis_struct[time]["AST"]["ref_low"]:
    #        event_time = time
    #        if file_name not in __event_dict.keys():
    #            __event_dict[file_name] = {}
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "AST too low (current value {}; reference value {})".format(ast_val, lis_struct[time]["AST"]["ref_low"])
    #        __event_dict[file_name][event_time].append(event_str)
    #else:
    #    if args.warn:
    ...
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "AST too low (current value {}; reference value {})".format(ast_val, __ast_ll)
    #        __event_dict[file_name][event_time].append(event_str)
    ...
    if ast_val > 1000:
        ...
        if event_time not in __event_dict[file_name].keys():
            __event_dict[file_name][event_time] = []
        event_str = "AST markedly elevated ({} ({})); consider ischemia, infection, toxicity".format(ast_val, lis_struct[time]["AST"]["unit"])
        __event_dict[file_name][event_time].append(event_str)
    ...
    #        if event_time not in __event_dict[file_name].keys():
    #            __event_dict[file_name][event_time] = []
    #        event_str = "AST/ALT > 2 (AST: {}, ALT: {}, AST/ALT: {}); consider alcoholic cirrhosis".format(ast_val, alt, ast_val/alt)
    #        __event_dict[file_name][event_time].append(event_str)
